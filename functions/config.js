const imagesInfo = [
    {
        url: 'https://firebasestorage.googleapis.com/v0/b/rock-paper-scissors-d9968.appspot.com/o/wait.png?alt=media&token=2816274a-e19d-4aca-8d21-b14fedb14813',
        heroName: 'Cosmic Bug',
        heroShoots: [
            {
                text: 'rock',
    ...
    {
        url: 'https://firebasestorage.googleapis.com/v0/b/rock-paper-scissors-d9968.appspot.com/o/rsz_minions.jpg?alt=media&token=afb4713b-3efc-439e-a61a-d47d0058b0a1',
        heroName: 'Fluffy Worm',
        heroShoots: [
            {
                text: 'rock',
                imageUrl: 'https://firebasestorage.googleapis.com/v0/b/rock-paper-scissors-d9968.appspot.com/o/hero_shoots%2Frock.jpg?alt=media&token=4b9d38a1-13cb-492e-bd07-90d984622a39'
