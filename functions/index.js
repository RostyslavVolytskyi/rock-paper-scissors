...
const HERO_NAME_CONTEXT = 'hero.name';
...
// b. the parameters that are parsed from the create_name intent
...
exports.rockPaperScissors = functions.https.onRequest((request, response) => {
    ...
    function defaultFallback (app) {
        ...
        app.ask(`I missed what you said. Say it again?`);
    ...
    //         app.ask('You did not select any hero from the list or carousel');
    //     } else if (param === 'COSMIC_BUG') {
    //         app.ask('Aha, User. Let"s see who has sharper mind! I trained a lot! So, what is your shoot?');
    //     } else if (param === 'FLUFFY_WORM') {
    //         app.ask('Hi User, lets play with you. To be continued.');
    //     } else {
    //         app.ask('You selected an unknown item from the list or carousel');
    //     }
    // });
